...
public class CalculatorView extends javax.swing.JFrame {
    ...
    private void compute(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_compute
        ...
        try {
            ...
            Object ref = context.lookup("java:global/EjbTutorialServer/EjbTutorialServer-ejb/Calculator!calculator.CalculatorRemote");
            CalculatorRemote remoteInterface = (CalculatorRemote) PortableRemoteObject.narrow(ref, CalculatorRemote.class);
            String res = remoteInterface.compute(num1, num2, op);
           result.setText(res); 
            // TODO EJB add error handling here
        } catch (Exception ex) {
