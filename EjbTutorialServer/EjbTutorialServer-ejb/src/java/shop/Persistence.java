...
public class Persistence {
    ...
    private Persistence() {
        ...
        persist(product);
        book = new Book(new GregorianCalendar(2012, 8, 19).getTime(), "Analyse und Design mit der UML 2.5", new BigDecimal("49.80"), "SE-2001");
        person = new Person("Oestereich", "Bernd");
        book.addAuthor(person);
        product = new Product(book, 4);
        persist(product);
        book = new Book(new GregorianCalendar(2009, 9, 17).getTime(), "UML-Kurzreferenz 2.3", new BigDecimal("16.80"), "SE-2002");
        book.addAuthor(person);
        product = new Product(book, 5);
        persist(product);       
        Film film = new Film("DVD", new Person("Kubrick", "Stanley"), "2001: Odyssee im Weltraum", new BigDecimal("19.98"), "F-3001");
